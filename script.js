...
canvas();
var clutter = "";
document.querySelector("#page1>h1").textContent.split("").forEach(function(char){
      clutter+=`<span>${char}</span>`

})
 document.querySelector("#page1>h1").innerHTML = clutter
 var clutter = "";
document.querySelector("#page1>p").textContent.split("").forEach(function(char){
      clutter+=`<span>${char}</span>`

})
 document.querySelector("#page1>p").innerHTML = clutter
 var tl= gsap.timeline();
 tl.to("#page1>h1>span",{
  stagger:0.1,
  opacity:0,
  scrollTrigger:{
    trigger:"#page1>h1>span",
    scroller:"#main",
    scrub:0.6,
    start:"top 32%",
    end:"100% top",
 ...
 function center(){
  var clutter = "";
  document.querySelector("#text-center>h2").textContent.split("").forEach(function(char){
        clutter+=`<span>${char}</span>`
  
  })
   document.querySelector("#text-center>h2").innerHTML = clutter
 }

 center();
 tl.to("#text-center>h2>span",{
  scrollTrigger:{
    trigger: "#text-center>h2>span",
    scroller:"#main",
    start:"top 90%",
    end:"top 30%",
    scrub:1,
 ...
 function center1(){
  var clutter = "";
  document.querySelector("#text-center>p").textContent.split("").forEach(function(char){
        clutter+=`<span>${char}</span>`
  
  })
   document.querySelector("#text-center>p").innerHTML = clutter
 }

 center1();
 tl.to("#text-center>p>span",{
  scrollTrigger:{
    trigger: "#text-center>p>span",
    scroller:"#main",
    start:"top 90%",
    end:"top 30%",
    scrub:1,
 ...
 function center2(){
  var clutter = "";
  document.querySelector("#text>p").textContent.split("").forEach(function(char){
        clutter+=`<span>${char}</span>`
 ...
 function center3(){
  var clutter = "";
  document.querySelector("#text>h2:nth-child(2)").textContent.split("").forEach(function(char){
        clutter+=`<span>${char}</span>`
  
  })
   document.querySelector("#text>h2:nth-child(2)").innerHTML = clutter
 }

 center3();
 tl.to("#text>h2:nth-child(2)>span",{
  scrollTrigger:{
    trigger: "#text>h2:nth-child(2)>span",
    scroller:"#main",
    start:"top 90%",
    end:"top 30%",
    scrub:1,
 ...
 function center4(){
  var clutter = "";
  document.querySelector("#text>h2:nth-child(3)").textContent.split("").forEach(function(char){
        clutter+=`<span>${char}</span>`
  
  })
   document.querySelector("#text>h2:nth-child(3)").innerHTML = clutter
 }

 center4();
 tl.to("#text>h2:nth-child(3)>span",{
  scrollTrigger:{
    trigger: "#text>h2:nth-child(3)>span",
    scroller:"#main",
    start:"top 90%",
    end:"top 30%",
    scrub:1,
...
document.querySelector("#page5>h1").textContent.split("").forEach(function(char){
 ...
 tl.from("#page5>h1>span",{
  ...
  stagger: {
    each: 0.15,
    from: "end" // Stagger the animation in reverse order
  },
  opacity:1
 })
 var clutter = "";
document.querySelector("#page6>h2").textContent.split("").forEach(function(char){
      clutter+=`<span>${char}</span>`
 ...
 tl.to("#elem-container ",{
  scrollTrigger:{
   trigger:"#elem-container ",
   scroller:"#main",
   scrub:2,
  //  markers:true,
   start:"top -550%",
